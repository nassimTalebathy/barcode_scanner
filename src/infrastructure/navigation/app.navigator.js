...
export const AppNavigator = () => {
  ...
  const options = {
    ...
    headerRight: () => (
      <IconButton icon="lock" color={MD3Colors.red500} size={20} onPress={onLogout}>
        Log out <MdLock />{' '}
      </IconButton>
    ),
  };
  ...
  return (
    <DriveImagesContextProvider>
      ...
      >
        <Stack.Screen name="Barcode scanner" options={options} component={BarcodeScannerScreen} />
        <Stack.Screen name="Images" options={options} component={DriveImagesScreen} />
      </Stack.Navigator>
    </DriveImagesContextProvider>
  );
};
